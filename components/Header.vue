<template>
      <div class="header">
        <nav >
            ...
            <label for="show-menu fixed-top" class="menu-icon"><i class="fas fa-bars"></i></label>
            <div class="content">
                ...
                <ul class="links">
                    ...
                    <li>
                      <nuxt-link to="/profil"><a href="">Profil Sekolah</a></nuxt-link>
                      </li>
                    <li>
                      <nuxt-link to="/galeri"><a href="">Galeri</a></nuxt-link>
                    </li>
                    <li>
